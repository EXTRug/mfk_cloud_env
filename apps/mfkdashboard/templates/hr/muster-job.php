    ...
    <div class="spacer-header">
        <div class="d-flex align-items-center mb-3">
            ...
            <div>
                ...
                <div class="heading-tagline d-flex align-items-center">(ID: Funnelname | 765432) &nbsp;&nbsp;&nbsp;<div class="d-flex align-items-center"><div class="status-dot active"></div> <span style="color:var(--primary) !important; font-weight:600 !important;">Aktiv</span>&nbsp;&nbsp;&nbsp; (46 Tage verbleibend)</div></div>
            </div>
        </div>
        <div class="dropdown">
